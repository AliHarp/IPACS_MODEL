...
info_table_ft <- add_header_lines(
  info_table_ft,
  values = "Capacity and Length of Stay Scenario Parameters as of 21/11/2022")
...
# CHANGE: Scenario outputs refer to filename used rather than current date
...
# CHANGE: Removed auto_parameters_loc code as no longer used
