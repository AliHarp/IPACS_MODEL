...
# Outputs:
# arr_plot - image with arrivals in each pathway and location for baseline or scenario
...
# - Simplified recoding
# - Tried adding capacity line, get error that it appears in 2nd plot for some of them, also axis boundary problems
...
plots <- function(pathway_data, path_loc) {
  ...
  # # AMY: depends on capacity, which is imported by model script. Also a bit repetitive. Could do with label.
  # bcap_line <- as.numeric(
  #   capacity[capacity$node==path_loc & capacity$scenario=="BCap", "capacity"])
  # s1cap_line <- as.numeric(
  #   capacity[capacity$node==path_loc & capacity$scenario=="S1Cap", "capacity"])
  # 
